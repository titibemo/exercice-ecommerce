...
INSERT INTO order_items (id_customer, created_at, name_product, quantity, unit_price) VALUES
  ((SELECT id_customer FROM customers WHERE email = 'alice.martin@mail.com'),    '2024-03-01 10:20', (SELECT id_product FROM products WHERE name_product = 'Casque Bluetooth X1000'),         1,  79.99),
  ((SELECT id_customer FROM customers WHERE email = 'alice.martin@mail.com'),    '2024-03-01 10:20', (SELECT id_product FROM products WHERE name_product = 'Puzzle 1000 pièces "Montagne"'), 2,  12.99),
  ((SELECT id_customer FROM customers WHERE email = 'bob.dupont@mail.com'),      '2024-03-04 09:12', (SELECT id_product FROM products WHERE name_product = 'Tapis de Yoga Comfort+'),        1,  19.99),
  ((SELECT id_customer FROM customers WHERE email = 'chloe.bernard@mail.com'),   '2024-03-08 15:02', (SELECT id_product FROM products WHERE name_product = 'Bouilloire Inox 1.7L'),          1,  29.99),
  ((SELECT id_customer FROM customers WHERE email = 'chloe.bernard@mail.com'),   '2024-03-08 15:02', (SELECT id_product FROM products WHERE name_product = 'Gel douche FreshEnergy'),        3,   4.99),
  ((SELECT id_customer FROM customers WHERE email = 'david.robert@mail.com'),    '2024-03-09 11:45', (SELECT id_product FROM products WHERE name_product = 'Haltères 5kg (paire)'),          1,  24.99),
  ((SELECT id_customer FROM customers WHERE email = 'emma.leroy@mail.com'),      '2024-03-10 08:10', (SELECT id_product FROM products WHERE name_product = 'Crème hydratante BioSkin'),      2,  15.90),
  ((SELECT id_customer FROM customers WHERE email = 'julien.fontaine@mail.com'), '2024-03-18 14:22', (SELECT id_product FROM products WHERE name_product = 'Jeu de société "Galaxy Quest"'), 1,  29.90),
  ((SELECT id_customer FROM customers WHERE email = 'katia.garnier@mail.com'),   '2024-03-20 18:00', (SELECT id_product FROM products WHERE name_product = 'Souris Gamer Pro RGB'),          1,  49.90),
  ((SELECT id_customer FROM customers WHERE email = 'katia.garnier@mail.com'),   '2024-03-20 18:00', (SELECT id_product FROM products WHERE name_product = 'Gel douche FreshEnergy'),        2,   4.99);
